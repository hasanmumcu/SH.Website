...
{
    [Authorize]
    public class AnalystContactsController : Controller
    {
        private readonly IApplicationDbContext _context;
        private readonly IFactory _factory;
        private readonly List<AnalystContactModel> AnalystContactList;
        private readonly IWebHostEnvironment _hostingEnvironment;
        public AnalystContactsController (IApplicationDbContext context, IFactory factory, IWebHostEnvironment environment)
        {
            _factory = factory;
        ...
        [AllowAnonymous]
        public async Task<IActionResult> Create([Bind("to,Subject,Message")] AnalystContactViewModel viewModel)
        {
            if (ModelState.IsValid)
            {

                if (await _factory.PostAnalystContactViewModel(viewModel))
                {
                    return RedirectToAction("Analyst", "Home");
                }
